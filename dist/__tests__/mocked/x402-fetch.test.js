...
function makeOkResponse(data = { result: "ok" }) {
    return {
        status: 200,
        ok: true,
...
function make402Response(body, paymentRequiredHeader = null) {
    return {
        status: 402,
        ok: false,
...
describe("x402Fetch – 402 with Coinbase format body", () => {
    it("retries with X-PAYMENT header containing valid base64 JSON", async () => {
        ...
        const paymentHeader = JSON.parse(Buffer.from(options.headers["X-PAYMENT"], "base64").toString("utf-8"));
...
describe("x402Fetch – PAYMENT-REQUIRED header (v2)", () => {
    it("parses header over body for payment requirements", async () => {
        ...
        mockFetch.mockResolvedValueOnce(make402Response(makeCoinbase402Body(), paymentRequiredHeader));
...
//# sourceMappingURL=x402-fetch.test.js.map